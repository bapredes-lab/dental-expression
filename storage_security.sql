...
-- 3. Permitir que usuarios autenticados eliminen archivos
CREATE POLICY "Admin puede eliminar archivos" ON storage.objects
FOR DELETE TO authenticated USING (bucket_id = 'expedientes-medicos');

-- 4. Permitir que el público vea archivos (Solo si decides hacerlo público luego,
